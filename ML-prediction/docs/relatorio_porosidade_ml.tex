...
construção, \textbf{intra-coluna} (corte vertical num único conjunto tabular). O ensaio
...
de GBDT na união de três recortes tabulares 7logs e testou-se no quarto, percorrendo os quatro
...
\bottomrule
\end{tabular}
\caption{LOO entre quatro recortes tabulares 7logs: treino na união dos outros três, teste no poço da linha.
