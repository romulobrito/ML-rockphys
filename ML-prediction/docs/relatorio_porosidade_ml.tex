...
ficheiro tabular pela coluna \texttt{Depth\_m}, mantendo o treino na fração rasa
complementar. Registem-se ablações de preditores e diagnóstico multivariado: correlações de Pearson
...
ordenar o conjunto pela profundidade tabular (\texttt{Depth\_m}), correspondendo no
protocolo principal a \(20\%\) dos registos (fração parametrizável no código).
...
(\texttt{numpy}, semente \(0\)). Os quantis empíricos \(2{,}5\%\) e \(97{,}5\%\)
...
precisão exportada, coerente com o acoplamento quase determinístico a GR já
documentado.
